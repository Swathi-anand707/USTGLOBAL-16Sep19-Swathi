...
public class SearchServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(session==null) {
			...
			req.setAttribute("info", info);// to send the object one servlet to other in jsp at once
			...
			//		if(info!=null) {
			//		out.println("<table align='center'>"); // which display the data in the form of table
			//		
			//		out.println("<tr>");
